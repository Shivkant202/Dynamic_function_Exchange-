...
HD_PWD='D:/STA_Dfx/STA_TRFI_final/STA_TRFI_DFX/STA_TRFI_DFX.runs/system_pr_decoupler_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pr_decoupler_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pr_decoupler_0_0.tcl
