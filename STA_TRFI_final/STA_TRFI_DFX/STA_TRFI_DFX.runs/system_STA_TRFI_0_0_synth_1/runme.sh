...
HD_PWD='D:/STA_Dfx/RECiprocal_root_with_decoupler/STA_TRFI_DFX/STA_TRFI_DFX.runs/system_STA_TRFI_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_STA_TRFI_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_STA_TRFI_0_0.tcl
