...
proc create_root_design { parentCell } {
  ...
  # Create instance: STA_TRFI_0, and set properties
  set STA_TRFI_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:STA_TRFI:1.0 STA_TRFI_0 ]
  ...
  set_property -dict [ list \
   CONFIG.ALL_PARAMS {HAS_SIGNAL_CONTROL 1 HAS_SIGNAL_STATUS 1 INTF {intf_0 {ID 0 VLNV xilinx.com:interface:axis_rtl:1.0 MODE slave SIGNALS {TVALID {PRESENT 1 WIDTH 1} TREADY {PRESENT 1 WIDTH 1} TDATA {PRESENT 1 WIDTH 64} TUSER {PRESENT 0 WIDTH 0} TLAST {PRESENT 1 WIDTH 1} TID {PRESENT 0 WIDTH 0} TDEST {PRESENT 0 WIDTH 0} TSTRB {PRESENT 0 WIDTH 8} TKEEP {PRESENT 1 WIDTH 8}}} intf_1 {ID 1 VLNV xilinx.com:interface:axis_rtl:1.0 MODE slave SIGNALS {TVALID {PRESENT 1 WIDTH 1} TREADY {PRESENT 1 WIDTH 1} TDATA {PRESENT 1 WIDTH 64} TUSER {PRESENT 0 WIDTH 0} TLAST {PRESENT 1 WIDTH 1} TID {PRESENT 0 WIDTH 0} TDEST {PRESENT 0 WIDTH 0} TSTRB {PRESENT 0 WIDTH 8} TKEEP {PRESENT 0 WIDTH 8}}}} IPI_PROP_COUNT 0} \
  ...
  connect_bd_intf_net -intf_net STA_TRFI_0_estStream [get_bd_intf_pins STA_TRFI_0/estStream] [get_bd_intf_pins pr_decoupler_0/s_intf_1]
connect_bd_intf_net -intf_net [get_bd_intf_nets STA_TRFI_0_estStream] [get_bd_intf_pins STA_TRFI_0/estStream] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets STA_TRFI_0_estStream]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins pr_decoupler_0/s_intf_0]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXI_S2MM] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  ...
  connect_bd_intf_net -intf_net pr_decoupler_0_rp_intf_0 [get_bd_intf_pins STA_TRFI_0/in_stream] [get_bd_intf_pins pr_decoupler_0/rp_intf_0]
connect_bd_intf_net -intf_net [get_bd_intf_nets pr_decoupler_0_rp_intf_0] [get_bd_intf_pins STA_TRFI_0/in_stream] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets pr_decoupler_0_rp_intf_0]
  connect_bd_intf_net -intf_net pr_decoupler_0_rp_intf_1 [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins pr_decoupler_0/rp_intf_1]
connect_bd_intf_net -intf_net [get_bd_intf_nets pr_decoupler_0_rp_intf_1] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets pr_decoupler_0_rp_intf_1]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins STA_TRFI_0/modType] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net pr_decoupler_0_decouple_status [get_bd_pins pr_decoupler_0/decouple_status] [get_bd_pins processing_system7_0/GPIO_I]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins STA_TRFI_0/ap_clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins pr_decoupler_0/decouple] [get_bd_pins processing_system7_0/GPIO_O]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins STA_TRFI_0/ap_rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
